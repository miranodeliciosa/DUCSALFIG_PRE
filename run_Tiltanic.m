function [] = run_Tiltanic(sub,flag_training, flag_block)
...
%SBA.event.anglesToRotate       = [32:2:46]; % FOR CODING 
...
Buttons = [KbName('ESCAPE') KbName('Q') KbName('SPACE') KbName('j') KbName('j') KbName('f') KbName('n') KbName('1!') KbName('2@') KbName('3#')];
